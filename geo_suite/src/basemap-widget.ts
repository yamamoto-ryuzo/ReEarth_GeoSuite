...
const html: string = `
  <style>
    ...
    .basemap-wrap { background-color: rgba(255, 255, 255, 0.3); border-radius: 8px; padding: 5px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); backdrop-filter: blur(4px); width: 100%; box-sizing: border-box; }
...
try {
  if (typeof reearth !== 'undefined' && reearth && reearth.ui && typeof reearth.ui.show === 'function') {
    reearth.ui.show(html, { width: 300, visible: true });
  }
} catch (e) {}
