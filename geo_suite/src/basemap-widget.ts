...
const html: string = `
  <style>
    ...
    .basemap-wrap { background-color: rgba(255, 255, 255, 0.3); border-radius: 8px; padding: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); backdrop-filter: blur(4px); width: 240px; box-sizing: border-box; }
