...
const html: string = `
  <style>
    ...
    .basemap-wrap { background-color: rgba(255, 255, 255, 0.3); padding: 5px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); backdrop-filter: blur(4px); width: 290px; margin-left: 10px; box-sizing: border-box; }
