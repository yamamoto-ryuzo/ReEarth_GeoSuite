...
function groundPointFromCamera(cameraPos) {
    try {
        if (!cameraPos)
            return null;
        ...
        if (lat0 === undefined || lng0 === undefined || h === undefined)
            return null;
